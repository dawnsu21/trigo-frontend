  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message:
          "Driver registration submitted successfully! Your application is pending admin approval. You will be notified once approved.",
      });
      ...
      let errorMessage =
        "Unable to complete registration. Please check all fields and try again.";
